...
---@param args { catalog: MonCatalog, rng: Gen4Lcrng, charmap: table<string, unknown>, games: table<string, integer>, languages: table<string, integer>, game: string, language: string }
---@return MonFactory
