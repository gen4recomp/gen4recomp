...
function T.underfilled_native_like_refits_an_uncropped_decorated_box()
  ...
  Assert.equal(outer.logicalWidth, 272, "the refit frame adds side room")
  Assert.equal(outer.logicalHeight, 240, "the refit frame reserves the 24px top and bottom")
