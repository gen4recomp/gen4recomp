...
local StarterChoiceAssetCompiler = require("romdump.src.digest.newgame.StarterChoiceAssetCompiler")
local StarterChoiceAssetCacheWriter = require("romdump.src.digest.newgame.StarterChoiceAssetCacheWriter")
