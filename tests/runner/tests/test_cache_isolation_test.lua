...
local SANITIZE_ENV =
  "unset G4RECOMP_TEST_RUN_DIR G4RECOMP_TEST_WORKERS G4RECOMP_TEST_WORKER G4RECOMP_TEST_AGGREGATE G4RECOMP_TEST_ACCEPTANCE_NAMESPACE G4RECOMP_TEST_PREPARATION G4RECOMP_DERIVED_CACHE_READY G4RECOMP_REQUIRE_ROM_TESTS;"
...
function T.a_legacy_cache_backed_focus_prepares_the_complete_scope_it_claims()
  withTempDirectory(function(root)
    local parentWorker = os.getenv("G4RECOMP_TEST_WORKER")
    ...
    Assert.equal(
      os.getenv("G4RECOMP_TEST_WORKER"),
      parentWorker,
...
function T.a_failed_scoped_preparation_keeps_the_previous_selection()
  withTempDirectory(function(root)
    ...
    local testRoot = root .. "/cache/g4recomp/rom-tests"
