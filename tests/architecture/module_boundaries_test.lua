...
local REPRESENTATIVE_MODULES = {
  ...
  items = "libs.items.src.ItemCatalog",
...
local PACKAGE_RULES = {
  ...
  mons = {
    ...
    scanRoot = "libs/mons",
    allowed = { mons = true, items = true, assets = true, codec = true, errors = true, math = true },
  },
  items = {
    sourcePrefix = "libs/items/src/",
    scanRoot = "libs/items",
    allowed = { items = true, assets = true, codec = true, errors = true, math = true },
  },
  storage = {
...
local APP_ROMDUMP_IMPORTS = {
  ...
  ["romdump.src.build.CacheControllerWorker"] = true,
  ["romdump.src.DerivedCacheState"] = true,
  ["romdump.src.FirstPlayCompletion"] = true,
...
function T.forbidden_edges_are_rejected_while_documented_seams_hold()
  ...
  local forbidden = {
    ...
    { source = "items", dependency = "libs.mons.src.Mon" },
    { source = "items", dependency = "libs.hgss.src.field.FieldSession" },
    { source = "items", dependency = "romdump.src.source.GameVersion" },
